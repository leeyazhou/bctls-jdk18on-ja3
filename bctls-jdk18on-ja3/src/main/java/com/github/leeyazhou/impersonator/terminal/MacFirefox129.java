 ...
 * v129.0.2
 */
public class MacFirefox129 extends AbstractImpersonatorFactory implements TlsExtensionHandler {
  ...
  protected void onSendClientHelloMessageInternal(Map<Integer, byte[]> clientExtensions) throws IOException {
    ...
    addSignatureAlgorithmsExtension(clientExtensions,
        ...
        SignatureAndHashAlgorithm.rsa_pss_rsae_sha256, SignatureAndHashAlgorithm.rsa_pss_rsae_sha384,
